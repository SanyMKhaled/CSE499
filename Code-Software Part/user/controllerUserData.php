...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO user (name,phone, email, password, code, status,location)
                        values('$name','$mobile' ,'$email', '$encpass', '$code', '$status','$location')";
        $data_check = mysqli_query($con, $insert_data);
        if($data_check){
            $subject = "Email Verification Code";
            $message = "Your verification code is $code";
            $sender = "From: lpgstore.bd@gmail.com";

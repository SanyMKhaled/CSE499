...
class OrderTransaction {
    ...
    public function saveTransactionQuery($post_data)
    {
        ...
        $sql = "INSERT INTO orders (customer_id,name, email, phone, amount, address, status, transaction_id,currency)
                                    VALUES ('$cid','$name', '$email', '$phone','$transaction_amount','$address','Pending', '$transaction_id','$currency')";
